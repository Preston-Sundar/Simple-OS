/**
 * This file is used to define any miscellanious functions used at the kernel level.
 * Such as printing messages and the kernel UI. 
 * These functions are really just used to debug when testing new additions.
 * 
 */

#include "include/kernel_misc.h"
 ...
 */
void k_printf_skeleton_message(const char *str, uint8_t section_id)
{
    ...
    case 0:
        ...
        for (uint8_t i = 2; i < 25; i++)
            video_memory[SCREEN_X * cy + i] = (video_memory[SCREEN_X * cy + i] & 0xFF00) | ' ';
